      ...
      <div className="relative h-[250px] sm:h-[350px] w-full">
        ...
        <div className="absolute bottom-6 left-0 w-full p-4 sm:p-6 sm:px-8 max-w-7xl mx-auto flex flex-col gap-4 z-20">
          <div className="flex gap-3 mb-1">
            ...
            <Badge className={`${qColor.badgeBg} ${qColor.lightText} border ${qColor.badgeBorder} px-3 py-1 rounded-full flex items-center gap-2 shadow-[0_0_15px_rgba(0,0,0,0.5)]`}>
                ...
                {category.items.length === 0 ? (
                  ...
                  category.items.map((item: any) => (
                    <Card key={item.id} className="group border border-white/5 bg-gradient-to-br from-white/[0.04] to-transparent hover:from-white/[0.08] hover:to-white/[0.02] hover:border-white/20 transition-all duration-300 cursor-pointer overflow-hidden rounded-[24px] flex flex-row shadow-xl hover:shadow-[0_10px_40px_rgba(0,0,0,0.3)]">
                      ...
                      <div className="flex-1 p-5 flex flex-col justify-between">
                        ...
                        <div className="mt-5 flex items-center justify-between">
                          ...
                          <Button 
                            ...
                            className="h-10 w-10 rounded-full bg-white/5 border border-white/10 text-white group-hover:bg-accent group-hover:border-accent group-hover:text-black group-hover:scale-110 active:scale-95 transition-all shadow-[0_4px_14px_transparent] group-hover:shadow-[0_4px_20px_rgba(250,204,21,0.4)]"
                          >
                      ...
                      {/* Item Image */}
                      <div className="relative w-[130px] sm:w-[150px] shrink-0 p-3 pl-0 flex items-center">
